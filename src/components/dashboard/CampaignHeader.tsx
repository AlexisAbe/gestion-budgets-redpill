      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-2 h-1.5 w-full rounded-full bg-secondary">
              <div className={`h-1.5 rounded-full ${percentageAllocated < 90 ? 'bg-yellow-400' : 'bg-green-500'}`} style={{
              width: `${percentageAllocated}%`
            }} />
            </div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {balancedCampaigns > 0 && filteredCampaigns.length > 0 ? `${(balancedCampaigns / filteredCampaigns.length * 100).toFixed(1)}% des campagnes` : 'Pas de campagnes'}
            </p>
          </CardContent>
        </Card>
        <Card>
